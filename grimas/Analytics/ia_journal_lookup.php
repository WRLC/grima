...
if(!empty($_GET['ISSN'])){
	...
	*/
	...
	$analytics_url = 'https://api-na.hosted.exlibrisgroup.com/almaws/v1/analytics/reports?path=%2Fshared%2FShared%20storage%20institution%2FReports%2FSCF%20Reports%2FVOLUMES%20HELD%20AT%20SCF%20-%20ISSN&limit=250&col_names=true&apikey=l7xx8e0562f43e9949c0882d8e3d5f685cea&filter=%3Csawx%3Aexpr%20xsi%3Atype%3D%22sawx%3Alist%22%20op%3D%22containsAny%22%0A%20%20xmlns%3Asaw%3D%22com.siebel.analytics.web%2Freport%2Fv1.1%22%20%0A%20%20xmlns%3Asawx%3D%22com.siebel.analytics.web%2Fexpression%2Fv1.1%22%20%0A%20%20xmlns%3Axsi%3D%22http%3A%2F%2Fwww.w3.org%2F2001%2FXMLSchema-instance%22%20%0A%20%20xmlns%3Axsd%3D%22http%3A%2F%2Fwww.w3.org%2F2001%2FXMLSchema%22%0A%3E%0A%3Csawx%3Aexpr%20xsi%3Atype%3D%22sawx%3AsqlExpression%22%3E%22Bibliographic%20Details%22.%22ISSN%22%3C%2Fsawx%3Aexpr%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Csawx%3Aexpr%20xsi%3Atype%3D%22xsd%3Astring%22%3E'.$ISSN.'%3C%2Fsawx%3Aexpr%3E%3C%2Fsawx%3Aexpr%3E';
      ...
      <div class="container task-AdminAddInstitution">
        ...
        <div class="card">
		  ...
		  <div class="card-body">
			...
			<form action="">
				<input type="text" name="ISSN" autofocus="autofocus" placeholder="1234-5678"/>
				<button type="submit">Submit</button>
			<br/>
			</form>
 		  <p>All volumes of title matching <span style="font-weight:bold"><?php echo $_GET['ISSN']; ?></span></p>
		<table border= '2'>
        <tr>
          <th>ISSN</th>
          <th>Title</th>
          <th>Barcode</th>
          <th>Tray Location</th>
          <th><span style="font-weight:bold">Volume</span></th>
        </tr>
    			<?php
				foreach ($analytics_xml->QueryResult->ResultXml->rowset->Row as $item ) {printf('<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td><span style="font-weight:bold">%s</span></td></tr>', $item->Column1, $item->Column2, $item->Column4, $item->Column7, $item->Column6);}      			
          ?>
    </table>
	</div></div></div></div>
</body>
