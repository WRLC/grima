              <form method="post" action="MoreSpeCollItems.php">
				...
				<div class="row">
				  <div class="form-row col-6 pb-4">
					<label class="col-4 col-form-label" for="alternative_call_number">Item Call Number</label>
					<input class="col-8 form-control" type="text" name="alternative_call_number" id="alternative_call_number" size="20" value="<?=$e($item['alternative_call_number'])?>">
				  </div>
				  <div class="form-row col-6 pb-4">
					<label class="col-4 col-form-label" for="internal_note_1">Internal Note 1</label>
					<input class="col-8 form-control" type="text" name="internal_note_1" id="internal_note_1" size="20" value="<?=$e($item['internal_note_1'])?>">
				  </div>
				  <div class="form-row col-6 pb-4">
