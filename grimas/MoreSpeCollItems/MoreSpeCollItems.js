document.addEventListener('DOMContentLoaded',()=>{
    ...
    const alternative_call_number_elt = document.getElementById('alternative_call_number');
    const internal_note_1_elt = document.getElementById('internal_note_1');
    ...
    const onUpdate = function(e) {
        ...
        const alternative_call_number = alternative_call_number_elt.value;
        const internal_note_1 = internal_note_1_elt.value;
    ...
    alternative_call_number.addEventListener('input',onUpdate);
    internal_note_1.addEventListener('input',onUpdate);
